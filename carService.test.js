...
describe("Car service tests", () => {
    describe("Test .isItExpensive(issue)", () => {
        ...
        it('should return correct result if issue different from engine or transmission', () => {
    ...
    describe('Test .discount(numberOfParts, totalPrice)', () => {
        ...
        it('should calculate correct discount if parts are in range [3,7]', () => {
        ...
        it('should calculate correct discount if parts are more than 7', () => {
        ...
        it('should return correct message if parts are less than 2',() => {
